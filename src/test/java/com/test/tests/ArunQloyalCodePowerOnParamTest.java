...
public class ArunQloyalCodePowerOnParamTest extends BaseClass {
	BaseClass baseClass;
	private static final String baseUrl = "https://qa-challenges-lightbulb.atlassian.io";
	private static final String endPointOn = "/api/allmethods/on";
	String power;
	String uri;
	...
	@Test
	public void powerSwitchedValue() throws ClientProtocolException, IOException {
		uri = baseUrl + endPointOn;
		power = "30";
		String expected = "Switch & custom power set successfully";
		...
		Assert.assertEquals(statusCode, BaseClass.CODE_200, "Validating response code");
